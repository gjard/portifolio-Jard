        ...
        <div className="flip-card-back">
          <ul className="sidebar-nav">
            <li className="sidebar-nav-icons">
              <a
                href="https://www.linkedin.com/in/gabriel-jard-90734b1a8/"
            ...
            <li className="sidebar-nav-icons">
              {" "}
              <a
                href="https://www.instagram.com/red_jard/"
                rel="opener noreferrer"
                target="_blank"
            ...
            <li className="sidebar-nav-icons">
              {" "}
              <a
                href="https://www.facebook.com/gjard/"
                rel="opener noreferrer"
                target="_blank"
